...
import { formatCompact, formatCurrency, formatPercentText } from "./formatCompact"
  ...
  switch (type) {
        ...
        <div className={cellCls}>
          <span
            className={
              ...
              (isPos
                ? "bg-[rgba(34,197,94,0.1)] text-[var(--green)] border-[rgba(34,197,94,0.25)]"
                : isNeg
    ...
    case "image":
      return (
        <div className={cellCls}>
          {value
            ? <img src={value as string} alt="" className="inline-block rounded-full" width={18} height={18} loading="lazy" />
